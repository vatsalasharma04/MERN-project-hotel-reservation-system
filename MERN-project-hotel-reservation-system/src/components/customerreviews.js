...
<main>   
  ...
  <div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">Our Favourite Customers </h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="feature col">
        ...
        <p>Amazing experience using bookhotel.com all was same as showed In The Site Really Enjoyed Must Trust Once!</p>
